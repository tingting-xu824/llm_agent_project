...
class AgentGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("AI Assistant - Unlimited Text Input")
        ...
        self.agent = Agent(
            ...
            instructions=load_prompt("agent1_ver2.txt"),
            tools=[WebSearchTool()]
        )
    ...
    def setup_ui(self):
        ...
        tk.Label(
            input_label_frame, 
            text="Enter your question (supports unlimited text length):", 
            font=("Arial", 12, "bold"),
            bg='#f0f0f0',
            fg='#333333'
        ).pack(side=tk.LEFT)
        ...
        # Initialize message
        self.add_message("System", "👋 Welcome to AI Assistant! You can enter text of any length.", "system")
    ...
    def update_ui_after_processing(self, message, is_error=False):
        ...
        # Restore send button
        self.is_processing = False
        self.send_button.config(state=tk.NORMAL, text="Send Message (Ctrl+Enter)")
